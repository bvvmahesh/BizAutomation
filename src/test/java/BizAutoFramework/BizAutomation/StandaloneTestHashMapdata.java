...
public class StandaloneTestHashMapdata extends BaseTest {

	@Test(dataProvider="getData")
	public void SubmitOrderDataFromHashMap(HashMap<String,String> input) throws InterruptedException, IOException
	{
	...
	public Object[][] getData()
	{
		...
		map.put("email", "mahesh245@gmail.com");
		map.put("password", "Mahesh@123");
		map.put("ProductName", "ZARA COAT 3");
		
		HashMap<Object,Object> map1 = new HashMap<Object,Object>();
		map1.put("email", "hanshith@gmail.com");
		map1.put("password", "Hanshith@123");
